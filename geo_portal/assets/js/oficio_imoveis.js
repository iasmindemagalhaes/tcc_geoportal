...
$.ajax('http://localhost:8080/geoserver/ows?',{
  ...
  data: {
    ...
    typename: 'bdgeo:bairro', //nome da camada no Geoserver
    srsname: 'EPSG:4326',
...
L.Geoserver = L.FeatureGroup.extend({
  ...
  legend: function () {
    ...
    legend.onAdd = function (map) {
      ...
      var url = "http://localhost:8080/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=bdgeo:oficio_imovel";
      div.innerHTML +=
        "<img src=" +
        url +
