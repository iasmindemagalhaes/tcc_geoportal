...
$.ajax('http://localhost:8080/geoserver/ows?',{
  ...
  data: {
    ...
    typename: 'bdgeo:unidade_assistencia_social', //nome da camada no Geoserver
    srsname: 'EPSG:4326',
...
function handleJson(data) {
    selectedArea = L.geoJson(data, {
      ...
      onEachFeature: function(feature, layer) {
        layer.bindTooltip(`<strong>${feature.properties.nome}</strong>`+`</br>`+`${feature.properties.sigla}`,{
          direction: 'top',
          permanent: false,
          sticky: true,
          offset: [10, 0],
...
var map = L.map("map", {
    ...
    zoom: 12,
    minZoom: 3,
    layers: [osm, wmsLayer, wfsLayer, wmsLayer2]
})
...
var overlayMaps = {
    "Bairros": wmsLayer,
    "Unidades de Assistência Social":wfsLayer,
